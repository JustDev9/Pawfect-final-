				...
				<div class="pets-grid">
					<div class="pet-card" v-for="pet in pets" :key="pet.id">
						...
						<div class="pet-info">
							...
							<router-link to="/pet-profile" class="btn"
								>Meet {{ pet.name }}</router-link
							>
						</div>
					</div>
				</div>
				...
				<div class="map-container">
					<div class="map-info">
						...
						<div class="location-details">
							<p>
								<strong>Address:</strong> Angeles City,
								Pampanga, Philippines
							</p>
							<p>
								<strong>Hours:</strong> Monday - Sunday, 9:00 AM
								- 6:00 PM
							</p>
			...
			steps: [
				{
					...
					description:
						"View our gallery of pets looking for their forever homes.",
				},
				{
					title: "Submit Application",
					description:
						"Fill out our adoption application form online.",
				},
				{
					title: "Meet & Greet",
					description:
						"Schedule a visit to meet your potential new pet.",
				},
				{
					title: "Home Check",
					description:
						"We ensure your home is a safe environment for the pet.",
				},
				{
	...
	methods: {
      ...
      `;
		...
		loadExternalScripts() {
			...
			script2.src =
				"https://files.bpcontent.cloud/2025/05/07/09/20250507090119-E9YC9Q2J.js";
